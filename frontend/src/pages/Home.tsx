  ...
  return (
    <div>
      <div className="flex flex-col items-center text-center mb-10">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 px-2">
          <span style={{ color: '#08c' }}>Telegram</span> без границ — быстро и безопасно
        </h1>
        <p className="text-gray-400 text-sm sm:text-base leading-relaxed max-w-2xl px-2">
      ...
      <div className="mb-8 max-w-2xl mx-auto px-1">
        <div className="bg-gray-900/60 border border-gray-800 rounded-xl px-4 py-4 sm:px-6 sm:py-6">
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <Link
          to="/proxies"
          className="bg-gray-800 hover:bg-gray-700 text-gray-200 text-sm font-medium rounded-lg px-5 py-2.5 transition-colors touch-manipulation"
        >
          Мои прокси
        </Link>
      </div>
